...
<table align="center">
  <tr>
    <td align="center" width="25%">
      <img src="https://via.placeholder.com/210x440?text=Authentication+Screen" width="210" alt="Secure Auth"/>
      <br><sub><b>1. Secure Authentication</b></sub>
    </td>
    <td align="center" width="25%">
      <img src="https://via.placeholder.com/210x440?text=Real-time+Chat+UI" width="210" alt="Real-time Chat"/>
      <br><sub><b>2. Real-Time Chat Engine</b></sub>
    </td>
    <td align="center" width="25%">
      <img src="https://via.placeholder.com/210x440?text=Gemini+AI+Assistant" width="210" alt="Gemini AI"/>
      <br><sub><b>3. Embedded Gemini Chat</b></sub>
    </td>
    <td align="center" width="25%">
      <img src="https://via.placeholder.com/210x440?text=Group+Management" width="210" alt="Group Administration"/>
